    ...
    <div className="w-full border border-white p-8 rounded-2xl flex flex-col gap-4">
      ...
      <div className="flex justify-end">
        <div className="flex flex-col gap-4">
          <p className="text-purple-700 text-end relative">
            {amount} <span className="before:content-[''] before:absolute before:size-2 before:rounded-full before:bg-mustard-yellow-400 before:bottom-[6px] before:right-[34px] px-2"></span>{price}
          </p>
          <button
          className="text-sm text-purple-500 font-medium"
          onClick={() => {

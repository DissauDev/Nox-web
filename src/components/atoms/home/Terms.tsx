  ...
  return (
    <div className="p-16 text-midnight-950 max-w-4xl flex flex-col ">
      ...
      <p className="text-lg font-ArialRegular mb-12">
        Welcome to the Nox Rewards Loyalty Program! Please carefully read these
      ...
      <p className="text-base font-ArialRegular mb-10">
        To participate in the Loyalty Program, you must be at least 18 years old
        and be a resident of the 50 United States, the District of Columbia, or
        Canada (excluding Quebec). Nox employees are eligible to participate in
        the Loyalty Program.
      </p>
      ...
      <p className="text-base font-ArialRegular mb-10">
        If you meet the eligibility requirements, you can enroll in the Loyalty
        Program by registering for a Nox account through our mobile application,
        website, or participating retail locations.
      </p>

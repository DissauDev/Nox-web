...
exports.detectBPM = exports.analyzeAudio = void 0;
var Tone = __importStar(require("tone"));
var analyzeAudio = function () { return __awaiter(void 0, void 0, void 0, function () {
    var mic, analyser, context;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent(); // Abre el flujo del micrófono
                ...
                return [2 /*return*/, { analyser: analyser, context: context }];
        }
    });
}); };
exports.analyzeAudio = analyzeAudio;
var detectBPM = function (analyser) {
    ...
    var totalEnergy = data.reduce(function (acc, val) { return acc + Math.abs(val); }, 0);
    ...
    var bpm = Math.max(60, Math.round(totalEnergy * 0.1)); // Ajusta el valor de '0.1' según sea necesario.
